...
class LabelsViewsTest(TestCase):
    fixtures = ['labels.yaml', 'users.yaml']
    ...
    def setUp(self):
        ...
        self.label_update_url1 = reverse('label_update', kwargs={'pk': 1})
        self.label_update_url2 = reverse('label_update', kwargs={'pk': 2})
        self.label_delete_url = reverse('label_delete', kwargs={'pk': 1})
    ...
    def test_auth_another_label_update_POST(self):
        ...
        self.label_update_url3 = reverse('label_update', kwargs={'pk': new_label.pk})
